    ...
    <main class="Center-global Cf">
      ...
      <form name="Forum" action="index.php" method="post">
        <p>
          ...
          <br>Opiště číselně <input type="text" name="Kod" size="3">&nbsp;stočtyřicettři <input type="submit" value="Odeslat zápis" title="Odeslat příspěvek" onFocus="Email_Blokace()">
        </p>  
      <form>
      ...
      if (isset($_POST['zprava'])) {
        if ($_POST['jmeno'] == '' || $_POST['email'] == '' || $_POST['zprava'] == '')   // Testujeme, zda některá položka nezůstala prázdná
          ...
          if ($_POST['Kod'] != 143)  /* Jednoduchá antispamová ochrama */
            echo '<p class="Chyba">Neopsali jsme správně antispamový kód.<br>Vyplňte prosím formulář znovu.</p>';
